...
export const menuData: Record<string, MenuItem[]> = {
  ...
  spirits: [
    ...
    },
    {
      ...
      price: "Bottle: 7,900 for 50cl/17,708br for 100cl | Glass: 450br",
      image: "",
      description: "",
    },
    {
    ...
    },
    {
      ...
      price: "Bottle: 7,000 for 50cl/11,900br for 100cl | Glass: 320br",
      image: "",
      description: "",
    },

    {
      ...
      price: "Bottle: 6,100 for 50cl/16,800br for 100cl | Glass: 450br",
      image: "",
      description: "",
    },
...
export function MenuSection({ activeTab }: { activeTab: string }) {
  ...
  const itemsPerPage = 8; // Show 24 items at a time on desktop
